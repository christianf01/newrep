...
# This code adds the testcase user programs: default_tickets, forktickets, getpinfo,
# high_sleep, high_tickets, processesinuse, random, setticket, stress_equal, stress_manylow,
# and switch_tickets to the makefile, and also a user program "three_proc" to generate input for a bar graph
# to show the distribution of ticks for three processes with a 3:2:1 ratio of tickets
